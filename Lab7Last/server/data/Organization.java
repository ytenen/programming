...
public class Organization implements Comparable<Organization>, Serializable {
    ...
    public Organization(int id, String name, Coordinates coordinates, String creationDate,  Integer annualTurnover, String fullName, OrganizationType type, Address officialAddress){
        this.id = id;
        this.name = name;
